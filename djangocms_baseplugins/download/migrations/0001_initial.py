...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Download',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='download_download', serialize=False, to='cms.CMSPlugin')),
                ...
                ('file', filer_addons.filer_gui.fields.FilerFileField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='download_download_download', to='filer.File', verbose_name='Download')),
            ],
            options={
                'abstract': False,
            },
