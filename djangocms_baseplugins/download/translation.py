...
from djangocms_baseplugins.download.models import Download
from . import conf



translation_fields = defaults.DJANGOCMS_BASEPLUGINS_TRANSLATED_FIELDS + conf.DOWNLOADPLUGIN_TRANSLATED_FIELDS
...
section_translation_fields = defaults.DJANGOCMS_BASEPLUGINS_TRANSLATED_FIELDS + conf.DOWNLOADPLUGIN_TRANSLATED_FIELDS
