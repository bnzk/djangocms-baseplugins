            ...
            fields=[
                ...
                (
                    ...
                    ckeditor.fields.RichTextField(
                        default="", verbose_name="text", blank=True
                    ),
                ),
                (
                    "email",
                    models.EmailField(
                        default="", max_length=254, verbose_name="email", blank=True
                    ),
                ),
                (
                    "website",
                    models.URLField(default="", verbose_name="website", blank=True),
                ),
                (
                    "phone",
                    models.CharField(
                        default="", max_length="32", verbose_name="phone", blank=True
                    ),
                ),
                (
                    "image",
