...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Person',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(parent_link=True, on_delete=models.CASCADE,
                ...
                ('first_name',
                 models.CharField(default='', max_length=255, verbose_name='first name')),
                ('last_name',
                 models.CharField(default='', max_length=255, verbose_name='last name')),
                (
                'body', ckeditor.fields.RichTextField(default='', verbose_name='text', blank=True)),
                ('email',
                 models.EmailField(default='', max_length=254, verbose_name='email', blank=True)),
                ('website', models.URLField(default='', verbose_name='website', blank=True)),
                ('phone',
                 models.CharField(default='', max_length='32', verbose_name='phone', blank=True)),
                ('image',
                 filer.fields.image.FilerImageField(on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(parent_link=True, on_delete=models.CASCADE,
                                                       related_name='person_personsection',
                                                       auto_created=True, primary_key=True,
                                                       serialize=False, to='cms.CMSPlugin')),
                ('title', models.CharField(default='', max_length=256, blank=True)),
                ('published', models.BooleanField(default=True)),
