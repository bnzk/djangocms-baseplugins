...
translation_fields = defaults.DJANGOCMS_BASEPLUGINS_TRANSLATED_FIELDS + conf.PERSONPLUGIN_TRANSLATED_FIELDS
...
translation_fields = defaults.DJANGOCMS_BASEPLUGINS_TRANSLATED_FIELDS + conf.PERSONSECTIONPLUGIN_TRANSLATED_FIELDS
