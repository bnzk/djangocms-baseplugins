...
class PersonBase(AbstractBasePlugin):
    ...
    salutation = models.CharField(
        _("Salutation"), blank=True, max_length=255, default=""
    )
    function = models.CharField(_("Function"), blank=True, max_length=255, default="")
    department = models.CharField(
        _("Department"), blank=True, max_length=255, default=""
    )
    first_name = models.CharField(
        _("First Name"), blank=True, max_length=255, default=""
    )
    ...
    def to_string(self):
        text = "%s %s" % (self.first_name, self.last_name)
        return text
