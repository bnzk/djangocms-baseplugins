...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='InlineGallery',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='inline_gallery_inlinegallery', serialize=False, to='cms.CMSPlugin')),
                ...
                ('height', models.CharField(blank=True, default='', max_length=32, verbose_name='Height')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gallery', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inline_gallery.InlineGallery')),
                ('image', filer.fields.image.FilerImageField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='inline_gallery_inlinegalleryimage_image', to=settings.FILER_IMAGE_MODEL, verbose_name='Image')),
            ],
            options={
                'abstract': False,
            },
