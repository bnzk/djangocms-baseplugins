        ...
        migrations.CreateModel(
            ...
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(auto_created=True,
                                                       ...
                                                       related_name='video_video', serialize=False,
                                                       to='cms.CMSPlugin')),
                ('title',
                ...
                ('video_url', models.URLField(blank=True, help_text='youtube & vimeo', null=True,
                                              verbose_name='Video Adresse')),
                ('autoplay', models.BooleanField(default=False, verbose_name='Autoplay')),
                ('controls', models.BooleanField(default=True, help_text='youtube only',
