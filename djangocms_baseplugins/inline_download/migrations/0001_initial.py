...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='InlineDownload',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='inline_download_inlinedownload', serialize=False, to='cms.CMSPlugin')),
                ...
                ('height', models.CharField(blank=True, default=b'', max_length=32, verbose_name='Height')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', filer_addons.filer_gui.fields.FilerFileField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='inline_download_inlinedownloadentry_download', to='filer.File', verbose_name='Download')),
                ('inline_downloads', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='downloads', to='inline_download.InlineDownload')),
            ],
            options={
                'ordering': ('order',),
                'abstract': False,
