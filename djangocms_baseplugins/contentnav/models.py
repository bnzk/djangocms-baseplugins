...
class ContentNavBase(AbstractBasePlugin):
    menu_depth = models.PositiveIntegerField(default=1, verbose_name=_("Depth"))
    cms_page = PageField(
        null=True, default=None, blank=True, help_text=_("Show submenu of this page")
    )
    sitemap = models.BooleanField(default=False, help_text=_("Show complete sitemap"))
