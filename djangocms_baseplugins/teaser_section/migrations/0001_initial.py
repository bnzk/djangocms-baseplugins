...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='TeaserSection',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(parent_link=True, on_delete=models.CASCADE,related_name='teaser_section_teasersection', auto_created=True, primary_key=True, serialize=False, to='cms.CMSPlugin')),
