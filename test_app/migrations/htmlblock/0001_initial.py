...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='HtmlBlock',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='htmlblock_htmlblock', serialize=False, to='cms.CMSPlugin')),
                ...
                ('htmlblock', models.TextField(help_text='Use with caution.', verbose_name='HTML Block')),
            ],
            options={
                'abstract': False,
            },
