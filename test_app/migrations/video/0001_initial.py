...
import djangocms_baseplugins.video.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_url', models.URLField(blank=True, help_text='youtube & vimeo', null=True, verbose_name='Video Adresse')),
                ('autoplay', models.BooleanField(default=False, verbose_name='Autoplay')),
                ('controls', models.BooleanField(default=True, help_text='youtube only', verbose_name='show controls')),
            ...
            bases=(djangocms_baseplugins.video.models.VideoModelMixin, 'cms.cmsplugin'),
        ),
    ]
