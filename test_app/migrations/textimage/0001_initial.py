...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='TextImage',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='textimage_textimage', serialize=False, to='cms.CMSPlugin')),
                ...
                ('body', ckeditor.fields.RichTextField(blank=True, verbose_name='Text')),
                ('image', filer.fields.image.FilerImageField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='textimage_textimage_image', to=settings.FILER_IMAGE_MODEL, verbose_name='Image')),
            ],
            options={
                'abstract': False,
            },
